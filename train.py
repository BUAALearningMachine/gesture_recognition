...
train_loader = data.DataLoader(train_dataset, batch_size=10, shuffle=True, num_workers=4)
test_loader = data.DataLoader(test_dataset, batch_size=10, shuffle=True, num_workers=4)
